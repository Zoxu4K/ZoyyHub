...
-- Replace your ZyyLoader.lua with this
...
-- ============================================
function ZyyLoader.LoadModule(moduleName)
...
-- ============================================
function ZyyLoader.EnableAntiDump()
...
-- UTILITY FUNCTIONS
-- ============================================
function ZyyLoader.GetSessionInfo()
    local info = {
...
function ZyyLoader.ResetRateLimit()
    local identifier = game:GetService("RbxAnalyticsService"):GetClientId()
    loadCounts[identifier] = 0
