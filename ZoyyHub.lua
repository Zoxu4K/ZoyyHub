...
-- Load ZoyyLoader
local ZoyyLoader = loadstring(game:HttpGet("https://github.com/Zoxu4K/ZoyyHub/blob/main/ZoyyLoader.lua"))()
...
-- CONFIG SYSTEM
-- ============================================
local ConfigSystem = loadstring(game:HttpGet("https://github.com/Zoxu4K/ZoyyHub/blob/main/ZoyyLoader.lua"))()
